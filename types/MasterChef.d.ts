...
interface MasterChefInterface extends ethers.utils.Interface {
  functions: {
    ...
    "pendingTf(uint256,address)": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "pendingTf", data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: "tfPerBlock", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "totalAllocPoint",
    data: BytesLike
  ): Result;
...
export class MasterChef extends Contract {
  ...
  functions: {
    ...
    tfPerBlock(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    tfPerBlock(overrides?: CallOverrides): Promise<PopulatedTransaction>;
